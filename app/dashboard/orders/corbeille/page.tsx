...
function ActionsCell(r: OrderRow, ctx: RenderCtx) {
  ...
  return (
    <div style={{ display: 'flex', gap: 4 }}>
      ...
      <ActionBtn icon={<RotateCcw size={12} />} title="Annuler la suppression" onClick={undoDelete}  color="#1B5E20" />
...
const COLUMNS: ColDef[] = [
  ...
  { key: 'date', label: 'Supprimée le', width: 105,
...
const BULK_ACTIONS: BulkActionDef[] = [
  { id: 'undo_delete', label: 'Annuler la suppression',  icon: <RotateCcw size={13} />, color: '#1B5E20' },
